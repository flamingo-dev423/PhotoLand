...
const ProductDetails = () => {
  ...
  if (data != null || data != undefined) {
    ...
    return (
      <div className="mb-16 pt-44 mb:pt-[30px] lg:pt-0">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row gap-[30px] mb-[30px]">
            ...
            <div className="flex-1 bg-primary p-12 lg:p-20 rounded-lg flex flex-col justify-center">
    ...
    console.log([]);
    return <div>oops!, Null Value.</div>;
  }
};
